    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="http://t.me/L_gami" style="margin-right:10px; text-decoration:none;">Haloo Selamat datang di halaman administrator</a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://www.t.me/L_gami/" style="color: rgb(243, 156, 18);">ada kendala hub 082324283418</a>
        </div>
      <?php } ?>
