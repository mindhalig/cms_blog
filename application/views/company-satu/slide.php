<div id="carousel-example-generic" class="carousel slide">
        ...
        <div class="carousel-inner" role="listbox" loading="lazy">
				...
				foreach ($utama1->result_array() as $row) {    
					...
					?>
					<img src="<?php echo base_url(); ?>asset/foto_banner/<?php echo $row['gambar'] ?>" loading="lazy" class="img-responsive"/>
                    <div class="carousel-caption animated fadeInLeft">
                            <h2 class="slide-text-heading" data-animation="animated bounceInDown">
                                <?php echo $row['judul'] ?>
                            </h2>
